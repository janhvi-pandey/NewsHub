...
const News = (props) => {
  ...
  const getHeadline = () => {
    const categoryFormatted = props.category.charAt(0).toUpperCase() + props.category.slice(1);
    return (
      <>
        Top Headlines in <span style={{ color: '#1565C0' }}>{categoryFormatted}</span> Domain
      </>
    );
  };
    ...
    <div>
      ...
      >
        ...
        <span
          ...
          id="typingtext"
          style={{ color: "#1565C0", fontWeight: '500', fontSize: '1.6rem' }}
        >
          <ReactTyped
            strings={[
    ...
    <div className="row d-flex justify-content-between align-items-center my-3">
      ...
      <div className="col-12 col-md-6 d-flex justify-content-md-end">
        <form
          ...
          style={{ display: "flex", alignItems: "center", marginTop: "20px", width: "100%" }}
        >
          <input
            type="text"
